...
Simple conversion from macOS screenrecording =.mov= to uploadable =.mp4=:
: ffmpeg -i "source.mov" -c:v h264 "target.mp4"
...
Or just a single jpeg saved to the same directory:
: magick foo.jpeg -auto-orient -strip -resize 1200x1200\> -quality 90 "_$i"
