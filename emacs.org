...
The *fill prefix* is a sequence of characters that should appear at the
start of any line that belongs to the group of lines which is to be
/filled/.
...
** Eshell (Emacs Shell written in elisp)
:PROPERTIES:
:CUSTOM_ID: eshell
:END:
