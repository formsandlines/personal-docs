...
See https://www.emacswiki.org/emacs/RegularExpression for a regex reference.
...
*Syntax classes* to use with ~\scode~ or ~\Scode~:
...
*Syntax classes*, square-bracket-delimited:
