...
*DOES NOT WORK WITH CUSTOM ELEMENTS (WEB COMPONENTS)*
- use ~document.importNode(Node, true)~ to clone a node with custom
  elements as children (\tilde30% slower than ~cloneNode~)
