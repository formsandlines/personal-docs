...
Relative references:
- ~@x~ / ~@xx~ / … → row of the first / second / … /x/
- ~@-x~ / ~@+x~ → row of the first /x/ /above/ / /below/ the current line
- ~@-n~ / ~@+n~ → row /n/ rows /above/ / /below/ the current line
...
| ~vlen(<list>)~            | count all numbers in a list         |
...
Example to sum all data rows of a column:
...
Example to count all data rows of a column:
